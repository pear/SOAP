...
class Interop_Client
{
    ...
    */    
    function fetchEndpoints($test = NULL) {
        ...
        $soapclient = new SOAP_Client($this->interopServer);
        ...
        if(!PEAR::isError($return)){
            ...
            if($ok){
                if (!$headers_ok) {
                    ...
                    $soap_test->setResult(1,'OK',$soap->wire);
                    $success = TRUE;
                }
            } else {
            ...
            $soap_test->setResult($ok,$res, $soap->wire,$fault['faultstring'], $fault);
        }
        return $ok;
    }
